...
dcon <- data.frame (lead_time, year, week, day, weekend_nights, week_nights, 
                    adults, children, babies, pre_cancel, pre_bcn, changes, 
                    days_wait, adr, rcar_parking_spaces, ts_requests)
dim(dcon)
